...
Filtrando los valores que son $0$ en las respuestas (las consideramos como respuestas inválidas), ajustamos el modelo de regresión ordinal *logit*
...
Acá se ve claramente cómo casi no hay una diferencia clara por edad. Por lo tanto, es razonable que ninguno de los dos modelos (el lineal truncado y el ordinal) de buenos resultados. Por otra parte, veamos la distribución de las clases en el conjunto de test
